# -*- coding: utf-8 -*-
#
# jsfsdb documentation build configuration file, created by
...
file_text = read(fpath('../jsfsdb/__meta__.py'))
...
latex_documents = [
    ('index', 'jsfsdb.tex', u'jsfsdb Documentation',
...
man_pages = [
    ('index', 'jsfsdb', u'jsfsdb Documentation',
...
texinfo_documents = [
    ('index', 'jsfsdb', u'jsfsdb Documentation',
        u'Ian Dennis Miller', 'jsfsdb', 'One line description of project.',
        'Miscellaneous'),
]
